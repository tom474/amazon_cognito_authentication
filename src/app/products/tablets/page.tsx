...
import { ShoppingCart, Star, Search, Tablet } from "lucide-react";
...
export default function TabletsPage() {
    ...
    useEffect(() => {
        const tabletProducts = getProductsByCategory("tablets");
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-lg text-gray-600">
                        Powerful tablets perfect for work, creativity, and
                        entertainment
                    </p>
                </div>
                ...
                {filteredProducts.length === 0 && (
                    <div className="text-center py-16">
                        <div className="text-gray-400 mb-4">
                            <Tablet className="h-16 w-16 mx-auto" />
                        </div>
