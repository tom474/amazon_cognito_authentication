...
import { ShoppingCart, Star, Search, Smartphone } from "lucide-react";
...
export default function PhonesPage() {
    ...
    useEffect(() => {
        const phoneProducts = getProductsByCategory("phones");
        setProducts(phoneProducts);
        setFilteredProducts(phoneProducts);
    }, []);
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-lg text-gray-600">
                        Latest smartphones from top brands with cutting-edge
                        technology
                    </p>
                </div>
